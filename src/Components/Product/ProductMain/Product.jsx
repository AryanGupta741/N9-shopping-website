...
const Product = () => {
  ...
  const product = StoreData.find((p) => p.productID === parseInt(productID)) || StoreData[0];
          ...
          <div className="productGallery">
            <div className="productThumb">
              {productImg.map((img, index) => (
                <img key={index} src={img} onClick={() => setCurrentImg(index)} alt="" />
              ))}
            </div>
          ...
          <div className="productDetails">
            <div className="productBreadcrumb">
              ...
              <div className="prevNextLink">
                <Link to={`/product/${product.productID - 1}`}>
                  <GoChevronLeft />
                  <p>Prev</p>
                </Link>
                <Link to={`/product/${product.productID + 1}`}>
